...
values 
(1, 'Beatriz', '19.117.826-3' ,'818.554.847-14', utc_timestamp, '2020-02-01 02:20:10', 3050, '83323-240', 'Rua Vinte e Dois de Abril', '1000', 'Centro');

insert into employee (id, name, rg, cpf, dt_update, dt_create, address_city_id, address_zip, address_type, address_number, address_block) 
values 
(2, 'Luana', '78.852.159-7' ,'386.887.195-00', utc_timestamp, '2020-02-01 02:20:10', 2904, '85852-010', 'Rua Castelo Branco', '8547', 'Vila Maracanã');

insert into employee (id, name, rg, cpf, dt_update, dt_create, address_city_id, address_zip, address_type, address_number, address_block) 
values 
(3, 'Katia', '89.148.559-2' ,'577.863.756-00', utc_timestamp, '2020-02-01 02:20:10', 4400, '69301-410', 'Avenida Capitão Júlio Bezerra', '741', 'Centro');
